...
const ColorPick = ({location}) => {
    ...
    let [myColor, pickedColor] = useState('#FFFFFF');
    let picker_data = {
        col: 12,
        row: 12,
        width: 300,
    ...
    return (
        <div>
            <div id='colorselector_header' >
                <Header />
            </div>
            <div className="container">
                <img className="example_image" src={state.img[item_id]} alt=""></img>
                <svg className="example_product-svg" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="600px" height="600px" viewBox="0 0 255 255">
                    <defs/>
                    <path id="product-shape" d={state.svg[item_id]} style={{fill: myColor}}/>
                </svg>
            </div>
            <div  id="colorselector_picker" >
                <ColorSelector pallet={picker_data} selectedColor={pickedColor} />
            </div>
            
            <Link to={`/customize/${myColor}/${item_id}`}>
                {/* <button >Go to Next Page</button> */}
                <img className="next_icon" src={next_path} height='40'/>
            </Link>
            
            <img className="color_banner" src={banner_path} height='80'/>
